...
"""
    ...
    自定义布局
"""
from PyQt5.QtCore import QRect, QPoint, pyqtSignal, Qt, QSize
from PyQt5.QtWidgets import QSizePolicy, QLayout, QSpacerItem


class FlowLayout(QLayout):
    """流式布局,使用说明 此处参阅：https://94e.cn/info/1352
